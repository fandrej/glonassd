...
Демон написан на языке C, собран компилятором gcc version 6.3.0 20170516 (Debian 6.3.0-18+deb9u1) (64-битная версия).
...
В базе данных PostgreSQL создать таблицу "[scheme.]tgpsdata" (см. скрипт tgpsdata.sql).<br>
...
**log_enable** - 0-запрет логирования, 1-основные события, 2/3 - более подробно<br>
